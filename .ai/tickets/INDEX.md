...
| KIT-T035 | bug | todo | high | Cache consumers trust a stale/corrupt DB; a test leaked DUP fixtures into the real cache |
| KIT-T036 | feature | review | high | \"status\" defaults to the cross-project briefing (terse, cache-backed) — not a single-repo readout |
| KIT-T037 | bug | todo | high | Programmatic resume omits in-flight background agents — make live work visible AND durable |
